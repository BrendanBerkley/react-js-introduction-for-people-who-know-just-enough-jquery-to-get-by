...
I also heard React.js was good and recently spent some time playing with it. Now that I'm pretty comfortable with React, I decided to write yet another tutorial on this subject.
...
**Start with the JSBin from the previous step. First, let's disable the button by adding `disabled`.**
...
We'll start with our previous jQuery implementation. We'll put our React.js code on hold.

<div class="message"><strong>✔ Click "Save" below</strong> to get started.</div>
...
Also, thanks [Brady Fukumoto](https://twitter.com/Brrr80/status/618897522505838592) for reading a draft version of this post.
